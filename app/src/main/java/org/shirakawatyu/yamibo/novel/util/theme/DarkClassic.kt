...
val DARK_MODE_CSS_RULES_CLASSIC = listOf(
    "/* === CSS 变量覆盖 === */",
    "body {",
    "--dz-BG-body: #050b14 !important;",
    "--dz-BG-0: #0b1625 !important;",
    "--dz-BG-5: #102338 !important;",
    "--dz-BG-6: #274766 !important;",
    "--dz-FC-fff: #d8e6f3 !important;",
    "--dz-FC-333: #c2d5e6 !important;",
    "--dz-FC-666: #a8bfd4 !important;",
    "--dz-FC-999: #7895b0 !important;",
    "--dz-FC-ccc: #8fa9c2 !important;",
    "--dz-FC-aaa: #66839f !important;",
    "--dz-BOR-ed: #1d3854 !important;",
    "--dz-FC-color: #c2d5e6 !important;",
    "}",
    "/* === 页面根背景 === */",
    ...
    "/* === 帖子中的链接 === */",
    ".message a, .postmessage a, .t_f a, .t_msgfont a { color: #63b3ed !important; }",
    "/* === 分页导航 === */",
    ...
    ".showcollapse_content a { color: #63b3ed !important; }",
    ...
    ".hui-media-content a { color: #63b3ed !important; }",
    ...
    "/* === 经典黑蓝最终覆盖 === */",
    "html body { background: #050b14 !important; color: #c2d5e6 !important; }",
    "html body .wp, html body #wp, html body .content, html body .main, html body .wrapper, html body .forumlist, html body .page, html body .hui-wrap { background: #050b14 !important; }",
    "html body .header, html body .header_toplogo, html body .sq_nav, html body .thread_nav, html body .z, html body .vertical_tab, html body .dhnav_box, html body #dhnav, html body #dhnav_li, html body .threadlist, html body .subforumshow, html body .pls, html body .footer, html body #footer, html body .hui-header { background: #08111f !important; border-color: #1d3854 !important; }",
    "html body .bm, html body .bm_c, html body .bm_h, html body .mlist1, html body .tl_bm, html body .threadlist li, html body .view_tit, html body .plc, html body .plm, html body .message, html body .postmessage, html body .t_f, html body .dialog, html body .p_pop, html body .myinfo, html body .myinfo_menu, html body table, html body td, html body th, html body .hui-content, html body .hui-media-list li, html body .hui-list { background-color: #0b1625 !important; border-color: #1d3854 !important; }",
    "html body input, html body select, html body textarea, html body blockquote, html body .quote, html body .blockcode, html body .notice, html body .tip, html body .alert, html body .warning, html body .showcollapse_title, html body .pg a, html body .page a { background: #102338 !important; border-color: #274766 !important; color: #c2d5e6 !important; }",
    "html body .sq_nav .a a, html body .thread_nav .a a, html body .sq_nav a.active, html body .thread_nav a.active, html body .z .a, html body .vertical_tab .a, html body .viewt-reply, html body .btn, html body .button, html body button, html body .pn, html body .pnc, html body .mbtn { background: #16385d !important; border-color: #2d5f8c !important; color: #e8f3fc !important; }",
    "html body a, html body .message a, html body .postmessage a, html body .t_f a, html body .hui-media-content a { color: #63b3ed !important; }",
    ...
    "html body h1, html body h2, html body h3, html body h4, html body h5, html body h6, html body p, html body span, html body li, html body dt, html body dd, html body td, html body th, html body label, html body strong, html body b { color: #c2d5e6 !important; }",
    ...
    "html body .xi1, html body .xi1 a, html body .xi2, html body .xi2 a, html body .f_c1, html body .f_c2, html body .f_c3, html body .f_c4, html body .f_c5, html body .f_c6, html body .f_c7, html body .f_c8, html body .f_c9 { color: #d8e6f3 !important; }",
    ...
    "html body .tag, html body .tag a, html body .pn em, html body .new, html body .hot, html body .xi3, html body .xi3 a, html body .xi4, html body .xi4 a { background: #102338 !important; color: #d8e6f3 !important; border-color: #274766 !important; }",
    "html body [style*=\"background:\" i]:not(img):not(svg):not(path):not(video):not(canvas):not(iframe) { background-color: #0b1625 !important; border-color: #1d3854 !important; }",
    "html body [style*=\"background-color:\" i]:not(img):not(svg):not(path):not(video):not(canvas):not(iframe) { background-color: #0b1625 !important; border-color: #1d3854 !important; }",
    "html body [style*=\"color:\" i]:not(img):not(svg):not(path):not(video):not(canvas):not(iframe) { color: #c2d5e6 !important; }",
    "html body [bgcolor] { background-color: #0b1625 !important; }",
    "html body [color], html body font[color] { color: #c2d5e6 !important; }",
    "html body [style*=\"#551200\" i], html body [style*=\"#993b22\" i], html body [style*=\"#fcf4cf\" i], html body [style*=\"rgb(85, 18, 0)\" i], html body [style*=\"rgb(153, 59, 34)\" i] { color: #c2d5e6 !important; background-color: #0b1625 !important; border-color: #1d3854 !important; }",
    "html body .swiper-slide, html body .swiper-slide a, html body .swiper-container, html body .swiper-wrapper, html body .scrolltop, html body .float-menu-item, html body .scrolltop a { background: #102338 !important; color: #d8e6f3 !important; border-color: #274766 !important; }",
    "html body .comiis_pgs a, html body .pgbtn, html body .pgbtn a, html body .pg label, html body .pg strong, html body .page strong, html body .pages, html body .pages a, html body .pages strong { background: #102338 !important; color: #d8e6f3 !important; border-color: #274766 !important; }",
    "html body .kmcolor, html body .quote blockquote, html body .blockcode code, html body pre, html body code { background: #08111f !important; color: #d8e6f3 !important; border-color: #1d3854 !important; }",
    "html body .header *, html body .sq_nav *, html body .thread_nav *, html body .z *, html body .vertical_tab *, html body .dhnav_box *, html body #dhnav *, html body #dhnavs *, html body .footer *, html body .hui-header * { color: #d8e6f3 !important; }",
