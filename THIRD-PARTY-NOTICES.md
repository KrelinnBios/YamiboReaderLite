...
本文件补充 [LICENSE](./LICENSE) 和 [NOTICE](./NOTICE)，用于说明 YamiboReaderLite 所使用、但不由本项目 AGPL-3.0 重新授权的上游代码、第三方软件、内容、数据和外部服务。具体组件、文件或内容旁如有更明确的权利声明，以该声明为准。
...
本项目使用或展示第三方材料，不代表 YamiboReaderLite 有权对其重新许可，也不代表相关权利人对本项目作出认可或背书。如发现版本、来源或权利标注不完整，请通过仓库反馈渠道指出相应组件、页面或内容。
